...
# ============================================================================
# RAG System v45 - Core Setup (Enhanced Chunker Integration)
# ============================================================================
# Legacy v44 code (VERBATIM) + Enhanced Chunker Config Flag
# ============================================================================

set -e

echo "============================================================================"
echo " RAG System v45 - Core Setup"
echo "============================================================================"
echo ""
...
<html>
<body>
<h1>Private SearXNG Instance</h1>
<p>This private SearXNG instance is used only for local RAG experimentation.
No user-identifiable logs are intentionally kept beyond default SearXNG behavior.</p>
</body>
</html>
EOF
...
# ============================================================================
# v45 NEW - ENHANCED CHUNKER FEATURE
# ============================================================================
...
log_ok "config.env created (with FEATURE_ENHANCED_CHUNKER_ENABLED)"
...
echo "============================================"
echo " RAG System v45 - Service Status"
echo "============================================"
echo ""
...
echo "============================================"
echo " RAG System v45 - Verification"
echo "============================================"
echo ""
...
echo ""
echo "============================================================================"
echo " Core Setup Complete! (v45 with Enhanced Chunker Support)"
echo "============================================================================"
echo ""
...
echo ""
echo "New in v45:"
echo " • Enhanced Chunker: FEATURE_ENHANCED_CHUNKER_ENABLED=true (config.env)"
echo " • Content-type aware chunking (tables/code/lists preserved)"
echo " • Legacy v44 fallback available (set flag to false)"
echo ""
echo "Next steps:"
echo " 1. bash setup-rag-ingest-v45.sh"
echo " 2. bash setup-rag-query-v45.sh"
echo " 3. ./ingest.sh"
